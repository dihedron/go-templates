...
// EditHandler is the implementation of the sax.EventHandler and sax.ErrorHandler
// interfaces.
...
// XML document.
func (h *EditHandler) OnStartDocument() error {
	h.stack.Clear()
	h.data = ""
	h.buffer.Reset()
	return nil
...
func (h *EditHandler) OnProcessingInstruction(element xml.ProcInst) error {
...
// EventHandler interface.
func (h *EditHandler) OnStartElement(element xml.StartElement) error {
...
// EventHandler interface.
func (h *EditHandler) OnEndElement(element xml.EndElement) error {
...
// EventHandler interface.
func (h *EditHandler) OnCharacterData(element xml.CharData) error {
...
// EventHandler interface.
func (h *EditHandler) OnComment(element xml.Comment) error {
	return nil
}

// OnEndDocument is the default, do-nothing implementation of the corresponding
// EventHandler interface.
func (h *EditHandler) OnEndDocument() error {
	return nil
}
...
func (h *EditHandler) OnError(err error) error {
	return err
}
